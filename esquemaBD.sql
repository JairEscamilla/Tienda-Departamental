-- -----------------------------------------------------
-- Table `ic18aeh`.`pr1_categorias_clientes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ic18aeh`.`pr1_categorias_clientes` (
...
-- -----------------------------------------------------
-- Table `ic18aeh`.`pr1_clientes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ic18aeh`.`pr1_clientes` (
  ...
  CONSTRAINT `idCategoria`
    ...
    REFERENCES `ic18aeh`.`pr1_categorias_clientes` (`idCategoriaC`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ic18aeh`.`pr1_tipo_pago`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ic18aeh`.`pr1_tipo_pago` (
...
-- -----------------------------------------------------
-- Table `ic18aeh`.`pr1_productos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ic18aeh`.`pr1_productos` (
...
-- -----------------------------------------------------
-- Table `ic18aeh`.`pr1_departamentos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ic18aeh`.`pr1_departamentos` (
...
-- -----------------------------------------------------
-- Table `ic18aeh`.`pr1_categorias_productos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ic18aeh`.`pr1_categorias_productos` (
  ...
  CONSTRAINT `idDepartamento`
    ...
    REFERENCES `ic18aeh`.`pr1_departamentos` (`idDepartamento`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ic18aeh`.`pr1_tipo_beneficio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ic18aeh`.`pr1_tipo_beneficio` (
...
-- -----------------------------------------------------
-- Table `ic18aeh`.`pr1_categoriasClientes_beneficios`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ic18aeh`.`pr1_categoriasClientes_beneficios` (
  ...
  CONSTRAINT `fk_pr1_categorias_clientes_has_pr1_tipo_beneficio_pr1_tipo_be1`
    ...
    REFERENCES `ic18aeh`.`pr1_tipo_beneficio` (`idBeneficio`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ic18aeh`.`pr1_tarjetas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ic18aeh`.`pr1_tarjetas` (
  ...
  CONSTRAINT `username`
    ...
    REFERENCES `ic18aeh`.`pr1_clientes` (`username`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ic18aeh`.`pr1_categorias_a_Productos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ic18aeh`.`pr1_categorias_a_Productos` (
  ...
  CONSTRAINT `fk_pr1_productos_has_pr1_categorias_productos_pr1_productos1`
    ...
    REFERENCES `ic18aeh`.`pr1_productos` (`idProducto`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_pr1_productos_has_pr1_categorias_productos_pr1_categorias_1`
    ...
    REFERENCES `ic18aeh`.`pr1_categorias_productos` (`idCategoriap`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `ic18aeh`.`pr1_compras` (
  ...
  CONSTRAINT `idTipoPago`
    ...
    REFERENCES `ic18aeh`.`pr1_tipo_pago` (`idTipoPago`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `user`
    FOREIGN KEY (`user`)
...
-- -----------------------------------------------------
-- Table `ic18aeh`.`pr1_compras_productos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ic18aeh`.`pr1_compras_productos` (
  ...
  CONSTRAINT `fk_pr1_compras_has_pr1_productos_pr1_compras1`
    ...
    REFERENCES `ic18aeh`.`pr1_compras` (`idCompra`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `ic18aeh`.`pr1_asesores`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ic18aeh`.`pr1_asesores` (
...
-- -----------------------------------------------------
-- Table `ic18aeh`.`pr1_quejas` 
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ic18aeh`.`pr1_quejas` (
  ...
  CONSTRAINT `fk_pr1_clientes_has_pr1_asesores_pr1_asesores1`
    ...
    REFERENCES `ic18aeh`.`pr1_asesores` (`idAsesor`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ic18aeh`.`pr1_devoluciones`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ic18aeh`.`pr1_devoluciones` (
...
-- -----------------------------------------------------
-- Table `ic18aeh`.`pr1_cancelacion`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ic18aeh`.`pr1_cancelacion` (
...
-- -----------------------------------------------------
-- Table `ic18aeh`.`pr1_comentarios`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ic18aeh`.`pr1_comentarios` (
